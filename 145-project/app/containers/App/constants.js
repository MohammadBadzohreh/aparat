...
export const DELETE_COMMENT = 'app/App/DELETE_COMMENT';
export const DELETE_COMMENT_SUCCESS = 'app/App/DELETE_COMMENT_SUCCESS';
export const DELETE_COMMENT_FAIL = 'app/App/DELETE_COMMENT_FAIL';

export const GET_CHANNEL_STATISTICS = 'app/App/GET_CHANNEL_STATISTICS';
export const GET_CHANNEL_STATISTICS_SUCCESS = 'app/App/GET_CHANNEL_STATISTICS_SUCCESS';
export const GET_CHANNEL_STATISTICS_FAIL = 'app/App/GET_CHANNEL_STATISTICS_FAIL';
...
export const GET_CHANNEL_INFORMATION = 'app/App/GET_CHANNEL_INFORMATION';
export const GET_CHANNEL_INFORMATION_SUCCESS = 'app/App/GET_CHANNEL_INFORMATION_SUCCESS';
export const GET_CHANNEL_INFORMATION_FAIL = 'app/App/GET_CHANNEL_INFORMATION_FAIL';
export const GET_CHANNEL_INFORMATION_CLEAR = 'app/App/GET_CHANNEL_INFORMATION_CLEAR';
